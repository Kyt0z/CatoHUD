...
function Cato_Team:drawWidget()
   ...
   if teamBinds ~= 0 then
      ...
      elseif (not showScores or isInMenu()) and self.teaming then
         ...
         self.teaming = false
         consolePerformCommand('bind game mousewheelup weapon 3; ui_kyto_weaponSwitch_empty 3')
         consolePerformCommand('bind game mousewheeldown weapon 7; ui_kyto_weaponSwitch_empty 7')
